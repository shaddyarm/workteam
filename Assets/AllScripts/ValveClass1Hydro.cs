...
public class ValveClass1Hydro : MonoBehaviour
{
	...
	void Start()
	{
		...
		if (Shtok != null)
		{
			Shtok.transform.localPosition = new Vector3(0, 0, 0.09f);
		}
	...
	void upd()
	{
		...
		if (Shtok != null)
		{
			Shtok.transform.localPosition = new Vector3(K * X * currentShift, K * Y * currentShift, K * (Z) * currentShift+0.09f);
		}
	}
}
