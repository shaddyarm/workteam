...
public class LipSyncClipSetup : ModalParent
{
	...
	private const float version = 1.521f;
	private const string versionNumber = "Pro 1.521";
	...
	{
		get { return data.emotionData; }
		set { data.emotionData = value; }
	}

	public List<GestureMarker> GestureData
	{
		get { return data.gestureData; }
		set { data.gestureData = value; }
	}
	...
	void OnEnable ()
	{
		...
		shortcutActions = new List<RDEditorShortcut.Action> {
			...
			new RDEditorShortcut.Action("AutoSync/Open AutoSync Window", ()=> { OpenAutoSyncWindow(0); }),
...
#region Top Menu
		...
		if (GUILayout.Button("AutoSync", EditorStyles.toolbarDropDown, GUILayout.Width(70)))
		{
			...
			autoMenu.AddSeparator("");
			autoMenu.AddItem(new GUIContent("Open AutoSync Window"), false, OpenAutoSyncWindow, 0);
...
#region AutoSync
	...
	void StartAutoSyncModule (object index)
	{
		...
		{
			AutoSyncWindow.CreateWindow(this, this, 0, i);
		}
	}
	...
	void StartAutoSyncPreset (object index)
	{
		...
		if (i >= 0 && i < presets.Length)
		{
			...
			disabled = true;
			autoSyncInstance.RunSequence(orderedModules, OnAutoSyncDataReady, (LipSyncData)data);
		}
	}
